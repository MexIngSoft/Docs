...
| `API.PY.DJANGO.Fiscora.Gateway` | `Docker.API.PY/API.PY.DJANGO.Fiscora.Gateway` | `https://github.com/MexIngSoft/API.PY.DJANGO.Fiscora.Gateway.git` | MVP creado, Git local asignado. |
...
2. `API.PY.DJANGO.Fiscora.Gateway`: BFF del portal.
