...
| `/admin` | JOBCRON.ADMIN.OVERVIEW.VIEW | `Docker.WEB.NJ/WEB.NJ.NEXT.JobCron/app/admin/page.tsx` | `components/admin-header.tsx`, `lib/modules.ts` | `GET /api/v1/projects/JOBCRON/admin/overview` implementado en API; UI aun usa `lib/modules.ts` | pendiente_consumo_dinamico |
