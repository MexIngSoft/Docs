# Agent especializado documentation-cleanup

## Alcance

Limpieza documental sin borrar fuentes, cierre de agents, duplicados, contradicciones, indices y archivo controlado.
