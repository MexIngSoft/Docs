# Indice maestro documental

| Dominio | Ruta | Descripcion | Estado | Prioridad | Owner |
|---|---|---|---|---|---|
| Audit | `00_audit/00_full_repository_map.md` | Mapa documental | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/00_inventory.md` | Inventario documental | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/01_consistency_matrix.md` | Matriz de consistencia documental | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/02_missing_documents.md` | Documentos faltantes detectados | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/03_inconsistencies.md` | Inconsistencias | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/04_document_status.md` | Estado documental | ACTIVE | P3 | Equipo documental |
| Audit | `00_audit/05_global_dictionary.md` | Diccionario global | ACTIVE | P3 | Equipo documental |
...
| Core | `01_core_erp/apis/02_catalog_api.md` | Catalog API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/03_supplier_api.md` | Supplier API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/04_pricing_api.md` | Pricing API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/05_quote_api.md` | Quote API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/06_sales_api.md` | Sales API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/07_logistics_api.md` | Logistics API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/08_rules_engine_api.md` | Rules Engine API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/09_gateway_api.md` | Tecno Telec Gateway API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/10_cart_api.md` | Cart API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/10_tecnotelec_api.md` | Tecno Telec API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/11_pos_api.md` | POS API | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/apis/12_government_tender_api.md` | GovernmentTender API | ACTIVE | P1 | Equipo documental |
...
| Core | `01_core_erp/architecture/events/event-driven-architecture.md` | Arquitectura de eventos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/architecture/events/event-naming.md` | Naming de eventos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/architecture/events/event-payloads.md` | Payloads de eventos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/architecture/scheduling/job-dependencies.md` | Dependencias de jobs | FUTURE_OR_PENDING | P2 | Equipo documental |
| Core | `01_core_erp/architecture/scheduling/scheduler-architecture.md` | Arquitectura de scheduler | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/architecture/scheduling/scheduler-rules.md` | Reglas de scheduler | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/devices.md` | Dispositivos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/permissions.md` | Permisos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/README.md` | Auth Core | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/roles.md` | Roles | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/security-policies.md` | Politicas de seguridad Auth | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/sessions.md` | Sesiones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/auth/tokens.md` | Tokens | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/00_database_overview.md` | Panorama de base de datos | FUTURE_OR_PENDING | P2 | Equipo documental |
| Core | `01_core_erp/database/01_schemas.md` | Schemas | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/02_entities.md` | Entidades oficiales | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/03_relationships.md` | Relaciones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/04_catalog_model.md` | Modelo Catalog | FUTURE_OR_PENDING | P2 | Equipo documental |
| Core | `01_core_erp/database/05_supplier_model.md` | Modelo Supplier | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/06_pricing_model.md` | Modelo Pricing | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/07_sales_model.md` | Modelo Sales | FUTURE_OR_PENDING | P2 | Equipo documental |
| Core | `01_core_erp/database/08_quotes_model.md` | Modelo Quote | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/09_cart_model.md` | Modelo de datos: Cart | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/10_pos_model.md` | Modelo de datos: POS | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/11_rules_model.md` | Modelo de datos: Rules | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/12_billing_model.md` | Modelo de datos: Billing | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/13_government_tender_model.md` | Modelo de datos: GovernmentTender | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/14_documents_model.md` | Modelo de datos: Documents | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/15_channel_assortment_model.md` | Modelo de datos: ChannelAssortment | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/16_product_compatibility_model.md` | Modelo de datos: ProductCompatibility | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/database/17_sql_server_table_publication.md` | Publicacion de nombres de tablas estilo SQL Server | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/00_erp_vision.md` | Vision ERP | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/01_modules.md` | Modulos ERP | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/02_rules_engine.md` | Rules Engine | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/03_quote_engine.md` | Motor de cotizacion | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/04_sales_model.md` | Modelo de ventas | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/05_purchase_model.md` | Modelo de compras | FUTURE_OR_PENDING | P2 | Equipo documental |
| Core | `01_core_erp/erp/06_logistics_model.md` | Modelo logistico | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/07_cart_model.md` | Modelo de carrito web | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/08_pos_model.md` | Modelo de punto de venta | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/09_system_states.md` | Estados del sistema | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/10_roles_permissions.md` | Roles y permisos | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/11_costs_profitability.md` | Costos, precios y utilidad | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/12_billing_returns.md` | Facturacion y devoluciones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/13_error_consistency.md` | Errores y consistencia | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/14_async_jobs_notifications.md` | Jobs asincronos y notificaciones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/15_bundles_kits.md` | Bundles y kits | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/16_addresses_customers.md` | Clientes y direcciones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/17_government_tender.md` | Modelo de licitaciones publicas | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/18_government_tender_adoption.md` | Uso de licitaciones por empresa | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/erp/19_supplier_catalog_strategy.md` | Estrategia de catalogo multi-proveedor | ACTIVE | P1 | Equipo documental |
...
| Core | `01_core_erp/flows/03_supplier_sync_flow.md` | Flujo de sincronizacion de proveedor | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/04_pricing_flow.md` | Flujo de pricing | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/05_logistics_flow.md` | Flujo logistico | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/06_order_flow.md` | Flujo de orden | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/07_cart_flow.md` | Flujo de carrito web | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/08_pos_flow.md` | Flujo de punto de venta | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/09_returns_flow.md` | Flujo de devoluciones | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/10_error_consistency_flow.md` | Flujo de errores y consistencia | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/flows/11_government_tender_flow.md` | Flujo de licitaciones publicas | ACTIVE | P1 | Equipo documental |
| Core | `01_core_erp/README.md` | Nucleo ERP | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/_ecosystem/00_ecosystem_overview.md` | Ecosistema empresarial | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/_ecosystem/01_company_portfolio.md` | Portafolio de empresas y proyectos | ACTIVE | P1 | Equipo documental |
...
| Business | `02_projects/datara/README.md` | Datara | FUTURE_OR_PENDING | P2 | Equipo documental |
...
| Business | `02_projects/jobcron/ui/03_dynamic_content_model.md` | Modelo de contenido dinamico JobCron | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/jobcron/ui/04_web_review_and_better_proposal.md` | Revision de web JobCron y propuesta mejorada | ARCHIVE_REFERENCE | P3 | Equipo documental |
...
| Business | `02_projects/nexora/README.md` | Nexora | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/nutriva/README.md` | Nutriva | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/pagora/README.md` | Pagora | FUTURE_OR_PENDING | P2 | Equipo documental |
...
| Business | `02_projects/social-networks/README.md` | Social Networks | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/stockara/README.md` | Stockara | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/00_initial_stage_readiness_review.md` | Revision de cierre de etapa inicial Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/AGENTE.md` | Agente de desarrollo Tecno Telec | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/auth/00_user_process.md` | Proceso de usuarios Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/backend/00_gateway_product_endpoints.md` | Endpoints publicos Gateway para productos | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/00_tecnotelec_identity.md` | Identidad de Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/01_objectives.md` | Objetivos | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/02_foda.md` | FODA | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/03_business_model.md` | Modelo de negocio | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/04_services.md` | Servicios | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/business/05_customer_segments.md` | Segmentos de cliente | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/business/06_value_proposition.md` | Propuesta de valor | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/cart/00_cart_future_process.md` | Proceso futuro de carrito, pedido y compra | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/catalog/00_public_catalog_process.md` | Proceso de catalogo publico Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/catalog/01_product_detail_process.md` | Proceso de detalle de producto | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/decisions/adr_0001_api_gateway_name.md` | ADR 0001 - Nombre del API Gateway | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/decisions/adr_0002_modular_erp_strategy.md` | ADR 0002 - Estrategia ERP modular | ACTIVE | P1 | Equipo documental |
...
| Business | `02_projects/tecnotelec/frontend/03_components.md` | Componentes | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/04_web_references.md` | Referencias web y visuales | ARCHIVE_REFERENCE | P3 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/05_design_system.md` | Sistema de diseno | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/06_image_sizes.md` | Tamanos de imagen | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/07_purchase_flow.md` | Flujo frontend de compra | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/08_quote_flow.md` | Flujo frontend de cotizacion | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/09_interface_proposal.md` | Propuesta de interfaz Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/10_pre_development_analysis.md` | Analisis previo al desarrollo web | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/11_web_platform_structure.md` | Estructura funcional de la plataforma web | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/12_initial_web_blueprint.md` | Blueprint inicial web Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/13_visual_mockup_spec.md` | Especificacion visual de maqueta Tecno Telec | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/14_navbar_standard.md` | Estandar de Navbar Tecno Telec | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/15_site_navigation_map.md` | Mapa de navegacion Tecno Telec | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/16_catalog_user_experience_correction.md` | Correccion de experiencia: catalogo visible Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/17_user_navigation_experience_review.md` | Revision de navegacion para usuario final | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/18_solution_navigation_map.md` | Mapa de navegacion de soluciones Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/18_stage_one_user_experience_closure.md` | Cierre etapa 1: experiencia publica Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/19_dynamic_catalog_and_navigation_rule.md` | Regla de catalogo y navegacion dinamica | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/20_manual_review_checklist_and_ports.md` | Checklist manual y puertos Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/21_product_catalog_interface_execution.md` | Ejecucion interfaz de productos Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/frontend/22_product_catalog_visual_responsive_execution.md` | Ejecucion visual responsiva del catalogo Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/pricing/00_price_publication_process.md` | Proceso de publicacion de precios en Web | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/pricing/01_advanced_pricing_future.md` | Pricing avanzado futuro | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/quotes/00_quote_process.md` | Proceso de cotizacion Tecno Telec | ACTIVE | P1 | Equipo documental |
...
| Business | `02_projects/tecnotelec/solutions/03_development_start_recommendation.md` | Recomendacion para cerrar analisis e iniciar desarrollo | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/solutions/05_solution_module_implementation_report.md` | Tecno Telec Solution Module Implementation Report | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/solutions/06_solution_detail_definition.md` | Definicion del detalle de soluciones | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/00_pending_tasks.md` | Tareas pendientes | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/01_required_apis.md` | APIs requeridas | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/02_required_tables.md` | Tablas requeridas | FUTURE_OR_PENDING | P2 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/03_required_frontend_views.md` | Vistas frontend requeridas | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/04_development_order.md` | Orden de desarrollo | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/05_mvp_scope.md` | Alcance MVP Tecno Telec | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/06_pricing_first_plan.md` | Plan Pricing First | ACTIVE | P1 | Equipo documental |
| Business | `02_projects/tecnotelec/tasks/07_pre_development_checklist.md` | Checklist previo a programar Tecno Telec | FUTURE_OR_PENDING | P2 | Equipo documental |
...
| Standards | `03_standards/frontend/catalog-visibility-rules.md` | Reglas de visibilidad en frontend | ACTIVE | P1 | Equipo documental |
| Standards | `03_standards/frontend/nextjs-project-standard.md` | Estandar de proyecto Next.js | FUTURE_OR_PENDING | P2 | Equipo documental |
...
| Standards | `03_standards/operations/provider-integration-standard.md` | Estandar para integrar proveedores | ACTIVE | P1 | Equipo documental |
| Standards | `03_standards/operations/reporting.md` | Reporting | ACTIVE | P1 | Equipo documental |
...
| Standards | `03_standards/security/password-policy.md` | Politica de password | ACTIVE | P1 | Equipo documental |
| Standards | `03_standards/security/secrets-management.md` | Manejo de secretos | ACTIVE | P1 | Equipo documental |
| Standards | `03_standards/testing/testing-strategy.md` | Estrategia de pruebas | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/ct-internacional/README.md` | Integracion CT Internacional | FUTURE_OR_PENDING | P2 | Equipo documental |
| Integration | `04_integrations/dc-mayorista/README.md` | Integracion DC Mayorista | FUTURE_OR_PENDING | P2 | Equipo documental |
| Integration | `04_integrations/README.md` | Integraciones | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-api-app.md` | Syscom Api App | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-auth.md` | SYSCOM Auth API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-brands.md` | SYSCOM Brands API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-categories.md` | SYSCOM Categories API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-exchange-rate.md` | SYSCOM Exchange Rate API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-product-detail.md` | SYSCOM Product Detail API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-products.md` | SYSCOM Products API | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/api_reference/syscom-related-accessories.md` | SYSCOM Related Products and Accessories APIs | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/docker-worker.md` | Worker Docker para ETLs SYSCOM | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/overview.md` | ETL overview | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/reset-and-auto-sync.md` | Reset limpio y sincronizacion automatica SYSCOM | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-brands.md` | ETL marcas | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-categories.md` | ETL categorias | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-products.md` | ETL productos | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-related-accessories.md` | ETL relacionados y accesorios | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-stock-prices.md` | ETL stock y precios | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/sync-token.md` | ETL token SYSCOM | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/syscom-commands.md` | Ejecutables SYSCOM | ACTIVE | P1 | Equipo documental |
| Integration | `04_integrations/syscom/etl/text-encoding-and-search.md` | SYSCOM text encoding and searchable catalog data | ACTIVE | P1 | Equipo documental |
